...
import {
  require_jsx_runtime
} from "./chunk-7TYO45ZP.js";
import {
  require_react
} from "./chunk-HOCPAHUW.js";
import {
  __privateAdd,
  __privateGet,
  __privateSet,
    ...
    case "active": {
      ...
      for (const o of t.hitRegions)
        if (o.separator) {
          ...
          ((_a = i.hasPointerCapture) == null ? void 0 : _a.call(i, e.pointerId)) || ((_b = i.setPointerCapture) == null ? void 0 : _b.call(i, e.pointerId));
        }
      at({
        document: e.currentTarget,
        event: e,
...
function Bt() {
  const [e, t] = (0, import_react.useState)({}), n = (0, import_react.useCallback)(() => t({}), []);
  return [e, n];
}
function Le(e) {
...
function se(e) {
  ...
  return q(() => {
    ...
    (...n) => {
      var _a;
      return (_a = t.current) == null ? void 0 : _a.call(t, ...n);
    },
    [t]
  );
}
...
function Ut({
  ...
  const x = (0, import_react.useRef)({
    onLayoutChange: {},
    onLayoutChanged: {}
  }), u = se((z) => {
    W(x.current.onLayoutChange, z) || (x.current.onLayoutChange = z, a == null ? void 0 : a(z));
  }), p = se((z) => {
    W(x.current.onLayoutChanged, z) || (x.current.onLayoutChanged = z, c == null ? void 0 : c(z));
  }), m = Le(r), S = (0, import_react.useRef)(null), [v, y] = Bt(), h = (0, import_react.useRef)({
  ...
  const M = se(
    (z, L) => {
      ...
      if (n == null ? void 0 : n[L])
        return {
          flexGrow: n == null ? void 0 : n[L]
        };
    }
  ), P = Re({
    defaultLayout: n,
  ...
  }), (0, import_jsx_runtime.jsx)(lt.Provider, { value: G, children: (0, import_jsx_runtime.jsx)(
    "div",
    {
      ...b,
      className: t,
...
function on({
  ...
  const i = t !== void 0, s = "id" in o ? o.id : o.groupId, l = he(s, t ?? []), r = (0, import_react.useSyncExternalStore)(
    Xt,
    () => n.getItem(l),
    () => n.getItem(l)
  ...
  }, [a, s, t, n]), f = a ?? c, g = (0, import_react.useRef)(null), d = (0, import_react.useCallback)(() => {
    const u = g.current;
  ...
  const b = (0, import_react.useCallback)(
    (u) => {
      d();
      let p;
...
function Yt({
  ...
  const u = !!a, p = Le(a), m = Re({
    disabled: s
  }), S = (0, import_react.useRef)(null), v = Ce(S, l), {
    getPanelStyles: y,
    id: h,
    orientation: w,
    registerPanel: M,
  ...
  }, L = (0, import_react.useSyncExternalStore)(
    (R) => ze(h, R),
    z,
    z
  );
  ...
  return L ? k = JSON.parse(L) : i ? k = {
    ...
    flexShrink: void 0,
    flexBasis: i
  } : k = { flexGrow: 1 }, (0, import_jsx_runtime.jsx)(
    "div",
    {
      ...x,
...
function Qt({
  ...
  const a = Le(s), c = Re({
    disabled: n,
    disableDoubleClick: o
  }), [f, g] = (0, import_react.useState)({}), [d, b] = (0, import_react.useState)("inactive"), [x, u] = (0, import_react.useState)(false), p = (0, import_react.useRef)(null), m = Ce(p, i), {
    disableCursor: S,
    id: v,
    orientation: y,
    registerSeparator: h,
  ...
  }, [v, a, h, c]), (0, import_react.useEffect)(() => {
